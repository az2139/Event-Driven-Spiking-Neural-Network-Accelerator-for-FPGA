...
entity snn_inference_profile_hls_regslice_both is
    generic (
        DataWidth   : INTEGER := 8);
    port (
        -- system signals
...
end entity snn_inference_profile_hls_regslice_both;

architecture behave of snn_inference_profile_hls_regslice_both is
